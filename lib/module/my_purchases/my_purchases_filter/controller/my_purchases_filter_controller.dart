...
class MyPurchasesFilterController extends GetxController {
  TextEditingController priceController1 = TextEditingController();
  TextEditingController priceController2 = TextEditingController();
  TextEditingController dateController1 = TextEditingController();
  TextEditingController dateController2 = TextEditingController();
  MyPurchasesController myPurchasesController = Get.find();
  ...
  void filterByPrice() async {
    ...
    data['data']['data'].forEach((element) {
      myPurchasesController.products.add(element);
    });
    myPurchasesController.update();
    Get.back();
    Get.back();
  }
  ...
  void filterByDate() async {
    ...
    Get.dialog( Center(child: CircularProgressIndicator(color: CustomColors.gold,)));
    Map<String, dynamic> data = await DioHelper.filterMyPurchasesByDate(
