                    ...
                    controller.privacyCheck==true?Center(
                      child: AppButton(
                          ...
                          onTap: () {
                            ...
                            if(!controller.inPerson&&controller.withMediatorShop&&(!controller.mediatorShopBetween && !controller.mediatorShopFromPlatform)){
                              Get.back();
                              Get.snackbar(AppWord.warning, AppWord.chooseMediatorShop);
                              controller.update();
                            }
                            else{
