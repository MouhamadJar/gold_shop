...
import 'package:gold_shop/module/reserved_purchase/view/reserved_purchase_view.dart';

class ReservedCard extends GetView<MyReservedPurchasesController> {
  const ReservedCard({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(MyReservedPurchasesController());
    return GetBuilder<MyReservedPurchasesController>(builder: (_) {
