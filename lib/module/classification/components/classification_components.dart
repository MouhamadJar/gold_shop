  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ClassificationController>(
      initState: (state){
        ...
        print(' subcategories length is :${controller.subcategories.length}');
      },
      builder: (_) {
        return GridView.builder(
          ...
          itemBuilder: (context, index) => DelayedDisplay(
            ...
            child: GestureDetector(
              onTap: () {
                print(controller.subcategories[index].id);
                Get.to(SubcategoryProducts(subcategoryId: controller.subcategories[index].id,pageTitle: controller.subcategories[index].name),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    AppNetworkImage(controller.subcategories[index].image,width: ScreenDimensions.widthPercentage(context, 10),),
                    Text(
