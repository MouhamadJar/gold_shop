...
import 'package:gold_shop/module/my_sells/my_sells_filter/controller/my_sells_filter_controller.dart';
import '../components/my_sells_filter_components.dart';

class MySellsFilter extends GetView<MySellsFilterController> {
  const MySellsFilter({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(MySellsFilterController());
    return SafeArea(
        child: Directions(
          child: Scaffold(resizeToAvoidBottomInset: false,
            ...
            body: GetBuilder<MySellsFilterController>(
              builder: (_) {
                return SizedBox(
