...
import 'package:gold_shop/module/update_product/view/update_product_payment_method_view.dart';
...
class UpdateProduct extends GetView<UpdateProductController> {
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        GetBuilder<UpdateProductController>(builder: (_) {
                          return Checkbox(
                ...
                AppButton(
                    ...
                    onTap: () {
                      ...
                      || controller.profitController.text == '0' || controller.manufacturerController.text.isEmpty
                        ...
                        Get.to(UpdateProductPaymentMethod(
                          productId: productId,
